...
export function Sidebar() {
  ...
  return (
    <nav className="fixed left-0 top-0 w-60 h-screen bg-gradient-to-b from-[#1a5f2a] to-[#0d3d18] text-white py-5 overflow-y-auto z-50">
      <div className="px-5 pb-5 border-b border-white/10 mb-5">
